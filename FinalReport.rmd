...
A new  preventative aides drug (triUmpsal) is under test in clinical trials. Consider the DrugUsers, does this drug seem effective?  Hint - use dplyr to obtain that subpopulation with the filter command.  Next repeat the analysis on just females, does this drug seem effective on women?
