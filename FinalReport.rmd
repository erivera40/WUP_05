...
A new  preventative aides drug (triUmpsal) is under test in clinical trials. Consider the DrugUsers, does this drug seem effective on this group?  Hint - use dplyr to obtain that sub population with the filter command.  Next, repeat the analysis on just females, does this drug seem effective on women?
